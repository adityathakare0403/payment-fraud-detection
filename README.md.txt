...
Below is the process for installation of all dependencies
...
  The Python code is given below   import csv
import happybase
...
connection.close()    Similarly create file for 2nd table import csv
import happybase
